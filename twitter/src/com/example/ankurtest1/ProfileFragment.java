...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle args) {
        ...
        showResult= (TextView)view.findViewById(R.id.showResult);
        showResult.setText("Json result");
        ...
        String data="";
    	StringBuilder sb = new StringBuilder("http://openweathermap.org/");
    	PlacesTask placesTask = new PlacesTask();
    	placesTask.execute(sb.toString());
    //	Toast.makeText(this, hashValue,0).show();
    	showResult.setText("Connecting...");
    	Log.d("My App Working", data);
        return view;
    }
    ...
    private class PlacesTask extends AsyncTask<String, Integer, String>{
        ...
        protected void onPostExecute(String result){
        	...
        	try {
    			...
    			hashValue=jObj.getString("coord");
    			Log.d("Helllo my hashvalue",hashValue );
    	        showResult.setText(Html.fromHtml("Your code is <b> </b>"));
